...
const confettiAnimation = useAssets([require("~/assets/lottie/confetti.json")]);
...
const HowToSleep = () => {
  const { currentStep, completedSteps, showCongratulations, setShowCongratulations } = useSleepStore()
    ...
    >
      <SafeAreaView className="flex-1">
        ...
        <CongratulationsDialog
          ...
          // confettiSource={confettiAnimation}
        />
      </SafeAreaView>
    </LinearGradient>
  )

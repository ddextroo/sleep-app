...
const Tab = ({ title, isActive, onPress }) => (
  <TouchableOpacity
  onPress={onPress}
  style={{ paddingHorizontal: 16, paddingVertical: 8, borderRadius: 999, backgroundColor: isActive ? "#5D3FD3" : "#2A2A40" }}
>
  <Text style={{ fontWeight: "500", color: isActive ? "white" : "gray" }}>{title}</Text>
</TouchableOpacity>

  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        ...
        { id: "8", title: "It's A Firefly Night!", artist: "Kids Storytime", coverImage: imageAssets[7], assetIndex: 6, category: "kids" }, // New Kids Category
        { id: "9", title: "The Little Bunny's Big Day", artist: "Kids Narrator", coverImage: imageAssets[7], assetIndex: 6, category: "kids" } // New Kids Category
      ];

  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        ...
        { id: "2", title: "DJ Raqi 2", artist: "Love Radio Manila", coverImage: imageAssets[0], assetIndex: 1 },
        { id: "3", title: "DJ Raqi 3", artist: "Love Radio Manila", coverImage: imageAssets[0], assetIndex: 2 },
        { id: "4", title: "Reddit Story 1", artist: "Narrator", coverImage: imageAssets[0], assetIndex: 3 },
        { id: "5", title: "Reddit Story 2", artist: "Narrator", coverImage: imageAssets[0], assetIndex: 4 },
      ];

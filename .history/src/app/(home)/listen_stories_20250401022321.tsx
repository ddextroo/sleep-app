  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        ...
        { id: "8", title: "It's A Firefly Night!", artist: "Kids Storytime", coverImage: imageAssets[6], assetIndex: 6, category: "kids" }, // New Kids Category
        { id: "9", title: "The Little Bunny's Big Day", artist: "Kids Narrator", coverImage: imageAssets[6], assetIndex: 6, category: "kids" } // New Kids Category
      ];
          ...
          <View className="mt-2">
            {audioList
              .filter((item) => {
                ...
                if (activeTab === "tab4") return item.category === "horror";
                return false;
              })
              .map((item) => (

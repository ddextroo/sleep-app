...
const Tab = ({ title, isActive, onPress }) => (
  <TouchableOpacity
    ...
    style={{
      ...
      paddingVertical: 8,
      borderRadius: 20,
      backgroundColor: isActive ? "#5D3FD3" : "#2A2A40",
    }}
  >
    <Text style={{ 
  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        ...
        { id: "6", title: "The Whispering Shadows", artist: "Horror Tales", coverImage: imageAssets[3], assetIndex: 5, category: "horror" },
        { id: "7", title: "Something's Watching Me At Night", artist: "Creepy Narrator", coverImage: imageAssets[3], assetIndex: 6, category: "horror" },
        { id: "8", title: "It's A Firefly Night!", artist: "Kids Storytime", coverImage: imageAssets[4], assetIndex: 7, category: "kids" },
        { id: "9", title: "The Stubborn Baby Elephant", artist: "Kids Narrator", coverImage: imageAssets[4], assetIndex: 8, category: "kids" }
      ];
    ...
    <LinearGradient colors={["#121212", "#1E1E30", "#231B36", "#1E1E30", "#121212"]} style={{ flex: 1 }}>
      <SafeAreaView className="flex-1">
        ...
        <View className="flex flex-row items-center gap-x-5">
          ...
          <Text style={{ color: "white", fontSize: 24, fontWeight: "bold" }}>Listen Stories</Text>
        </View>
          ...
          {audioList
            .filter((item) => {
              ...
              if (activeTab === "tab4") return item.category === "kids"; // New Filter

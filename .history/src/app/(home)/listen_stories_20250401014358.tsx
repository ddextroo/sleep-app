...
const ListenStories = () => {
  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        { id: "1", title: "He was my favorite 'Hello' and my hardest 'Goodbye'1", artist: "Love Radio Manila", coverImage: imageAssets[0], assetIndex: 0 },
        { id: "2", title: "Kinuha akong ninong ni EX!", artist: "Love Radio Manila", coverImage: imageAssets[1], assetIndex: 1 },
        { id: "3", title: "DJ Raqi 3", artist: "Love Radio Manila", coverImage: imageAssets[2], assetIndex: 2 },

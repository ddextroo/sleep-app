  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        ...
        { id: "5", title: "Wife Left Me And Came Back With A Baby, Begging For A Second Chance", artist: "Narrator", coverImage: imageAssets[2], assetIndex: 4, category: "reddit" },
        ...
        { id: "9", title: "The Little Bunny's Big Day", artist: "Kids Narrator", coverImage: imageAssets[7], assetIndex: 8, category: "kids" }
      ];

...
const ListenStories = () => {
  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const audioData = [
        { id: "1", title: "He was my favorite 'Hello' and my hardest 'Goodbye'", artist: "Love Radio Manila", coverImage: imageAssets[0], assetIndex: 0 },
        { id: "2", title: "Kinuha akong ninong ni EX!", artist: "Love Radio Manila", coverImage: imageAssets[1], assetIndex: 1 },
        { id: "3", title: "Pinagpalit niya ang 8 years sa babaeng kakakilala lang niya", artist: "Love Radio Manila", coverImage: imageAssets[2], assetIndex: 2 },
        { id: "4", title: "Excluded From My Sisters Wedding", artist: "Narrator", coverImage: imageAssets[3], assetIndex: 3 },
        { id: "5", title: "Wife Left Me And Came Back With A Baby, Begging For A Second Chance", artist: "Narrator", coverImage: imageAssets[4], assetIndex: 4 },
      ];
      ...
      <SafeAreaView className="flex-1">
        <ScrollView className="px-5 py-5">
          ...
          <View className="flex-row space-x-3 mb-5 gap-x-3">
            ...
            <Tab title="Horror Stories" isActive={activeTab === "tab2"} onPress={() => setActiveTab("tab2")} />
          </View>

...
const CalmSound = () => {
  ...
  useEffect(() => {
    const loadAudioMetadata = async () => {
      ...
      const soundData = [
        { id: "1", title: "One Summer's Day", artist: "knoa Piano Music", category: "nature", coverImage: "https://via.placeholder.com/60", assetIndex: 0 },
        { id: "2", title: "The Path of Wind", artist: "knoa Piano Music", category: "nature", coverImage: "https://via.placeholder.com/60", assetIndex: 1 },
        { id: "3", title: "Carrying You", artist: "knoa Piano Music", category: "nature", coverImage: "https://via.placeholder.com/60", assetIndex: 2 },
        { id: "4", title: "If I Could Be The Ocean", artist: "knoa Piano Music", category: "nature", coverImage: "https://via.placeholder.com/60", assetIndex: 3 },
        { id: "5", title: "My Humble Cottage", artist: "knoa Piano Music", category: "nature", coverImage: "https://via.placeholder.com/60", assetIndex: 4 },
        { id: "6", title: "Euphorbia", artist: "Spatial Dreams", category: "meditation", coverImage: "https://via.placeholder.com/60", assetIndex: 5 },
        { id: "7", title: "Enigma", artist: "Prophétique", category: "meditation", coverImage: "https://via.placeholder.com/60", assetIndex: 6 },
    ...
    <LinearGradient colors={["#121212", "#1E1E30", "#231B36", "#1E1E30", "#121212"]} style={{ flex: 1 }}>
      <SafeAreaView className="flex-1">
        <ScrollView className="px-5 py-5">
          ...
          {audioList
            .filter((item) => item.category === activeTab) // Filtering based on selected category
            .map((item) => (

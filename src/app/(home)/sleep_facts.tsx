    ...
    >
      <SafeAreaView className="flex-1 px-5 py-5">
        ...
        <View className="flex flex-row items-center gap-x-5">
          ...
          <Text className="text-white font-sans-bold text-3xl py-5">Sleep Facts</Text>
        </View>

        <Text className="text-white font-sans-semibold text-xl mb-3">
          Uncover surprising truths about how sleep affects your health, energy levels, and daily performance.
        </Text>
        ...
        >
          <View className="bg-[#2d2d4e] rounded-xl p-6 flex items-center justify-center mt-10">
            ...
            <Text className="text-white text-lg font-sans-bold mb-6">Did you know?</Text>
        ...
        <View className="flex-row justify-between items-center mt-6">
          ...
          >
            <ChevronLeft size={30} color="#8A7CFF" />
          </TouchableOpacity>
          <Text className="text-white font-sans">{`${currentFactIndex + 1} / ${sleepFacts.length}`}</Text>
          <TouchableOpacity
            onPress={nextFact}
            disabled={currentFactIndex === sleepFacts.length - 1}
            className={currentFactIndex === sleepFacts.length - 1 ? "opacity-50" : ""}
          >
            <ChevronRight size={30} color="#8A7CFF" />
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </LinearGradient>
